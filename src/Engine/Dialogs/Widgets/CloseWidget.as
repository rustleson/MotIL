...
package Engine.Dialogs.Widgets {
	...
	public function CloseWidget(x:Number = 0, y:Number = 0, w:Number = 0, h:Number = 0, cb:Function = null,
	...
	protected override function draw():void {
		...
		this.sprite.graphics.lineStyle(w * 0.1, this.color, 1);
		this.sprite.graphics.beginFill(Utils.colorDark(this.color, 0.7), 1);
		this.sprite.graphics.drawEllipse(tx - w/2, ty - h/2, w, h);
		this.sprite.graphics.endFill();
		this.sprite.graphics.lineStyle(w * 0.1, this.color, 1);
		this.sprite.graphics.moveTo(tx - w / 4, ty - h / 4);
		this.sprite.graphics.lineTo(tx + w / 4, ty + h / 4);
		this.sprite.graphics.moveTo(tx + w / 4, ty - h / 4);
		this.sprite.graphics.lineTo(tx - w / 4, ty + h / 4);
	    }
	}
