...
package TestBed{
	...
	public function Update():void {
	    ...
	    // joints
	    /*for (var jj:b2Joint = m_world.GetJointList(); jj; jj = jj.GetNext()){
		//DrawJoint(jj);
	    }
	    // bodies
	...
	public function DrawShape(shape:b2Shape):void{
		...
		case 0: //b2Shape.e_circleShape:
			...
			var pos:b2Vec2 = circle.GetLocalPosition();
			var r:Number = circle.GetRadius();
		...
		case 1: //b2Shape.e_polygonShape:
			...
			var tV:b2Vec2 = poly.GetVertices()[0];
			m_sprite.graphics.lineStyle(1,0xffffff,1);
